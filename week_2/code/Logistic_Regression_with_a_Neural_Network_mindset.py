...
def optimize(w, b, X, Y, num_iterations=100, learning_rate=0.009, print_cost=False):
    ...
    for i in range(num_iterations):
        ...
        grads, cost = propagate(w, b, X, Y)  # Call to the propagate function
...
def predict(w, b, X):
    ...
    for i in range(A.shape[1]):
        if A[0, i] > 0.5:
            Y_prediction[0, i] = 1  # Predict 1 if the probability is greater than 0.5
        else:
            Y_prediction[0, i] = 0  # Predict 0 if the probability is less than or equal to 0.5
